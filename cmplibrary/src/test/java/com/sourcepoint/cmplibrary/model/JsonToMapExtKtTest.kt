...
class JsonToMapExtKtTest {
    ...
    fun `GIVEN a consent object RETURN a JSON`() {
        ...
        val map: Map<String, Grant?> = mapOf(
            "5fbe6f050d88c7d28d765d47" to Grant(true, mapOf("60657acc9c97c400122f21f3" to true, "60657acc9c97c400122f21fa" to true)),
            "5fbe6f090d88c7d28d765e1e" to Grant(true, mapOf("60657acc9c97c400122f21f3" to true)),
            "5fbe6f0a0d88c7d28d765e25" to Grant(false, mapOf("60657acc9c97c400122f220c" to false, "60657acc9c97c400122f2212" to true))
        )
