...
class SourcePointClientBuilder {
    ...
    SourcePointClientBuilder(Integer accountId, String propertyName, Integer propertyId, boolean staging) throws ConsentLibException.BuildException {
        this.accountId = new EncodedParam("AccountId", accountId.toString());
        this.property = new EncodedParam("SiteName", "https://"+propertyName);
