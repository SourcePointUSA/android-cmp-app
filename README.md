...
- [Usage](#usage)
  ...
  - [Delegate Methods](#delegate-methods)
    - [Event Callbacks](#event-callbacks)
      - [onUIReady](#onuiready-view-view)
      - [onAction](#onaction-view-view-consentaction-consentaction)
      - [onUIFinished](#onuifinishedview-view)
...
...
dependencies {
    implementation 'com.sourcepoint.cmplibrary:cmplibrary:6.3.5'
}
```
...
- [`onUIFinished()`](#onUIFinished())
- [`onConsentReady()`](#onConsentReady())
- [`onError()`](#onError())

Th purpose and action for each of these functions are listed below
