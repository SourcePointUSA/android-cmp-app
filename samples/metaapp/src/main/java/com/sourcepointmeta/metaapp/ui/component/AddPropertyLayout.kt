...
internal fun AddPropertyLayout.bind(property: Property) {
    prop_name.setText(property.propertyName)
    account_id_tv.setText(property.accountId.toString())
...
internal fun AddPropertyLayout.toProperty(): Property {
    ...
    val gdprTp = gdpr_chip_group.children
        ...
        .map {
            MetaTargetingParam(
                propertyName = prop_name.text.toString(),
    ...
    val gdprStatus = StatusCampaign(prop_name.text.toString(), CampaignType.GDPR, chipGdprChecked)
    val ccpaStatus = StatusCampaign(prop_name.text.toString(), CampaignType.CCPA, chipCcpaChecked)

    return Property(
        propertyName = prop_name.text.toString(),
        accountId = account_id_tv.text.toString().toLong(),
        propertyId = 1,
        pmId = "",
        authId = null,
