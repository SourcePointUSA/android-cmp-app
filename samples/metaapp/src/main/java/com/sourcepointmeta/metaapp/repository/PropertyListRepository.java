...
public class PropertyListRepository {
    ...
    public MutableLiveData<Integer> updateProperty(final Property property) {
        ...
        mAppExecutors.diskIO().execute(() -> {
            ...
            int propertyId = mPropertyListDao.update(property.getAccountID(), property.getPropertyID(), property.getProperty(), property.getPmID() ,property.isStaging(), property.isNative(), property.getAuthId(), property.getMessageLanguage(), property.getPmTab(),property.getId());
            propertyID.postValue(propertyId);
            List<TargetingParam> listOfParams = new ArrayList<>();
            List<TargetingParam> targetingParamList = property.getTargetingParamList();
    ...
    public LiveData<Integer> getPropertyWithDetails(Property property) {
        ...
        mAppExecutors.networkIO().execute(() -> {
            ...
            if (keyList.isEmpty()){
                int propertyCount = mPropertyListDao.getPropertyWithDetails(property.getAccountID(), property.getPropertyID(), property.getProperty(), property.getPmID(), property.isStaging(), property.isNative() ,property.getAuthId(), property.getMessageLanguage(), property.getPmTab());
            ...
            List<TargetingParameterList> paramList = mPropertyListDao.getPropertyWithDetails(property.getAccountID(), property.getPropertyID(), property.getProperty(), property.getPmID(), property.isStaging(), property.isNative(),
                    property.getAuthId(), property.getMessageLanguage(), property.getPmTab(), keyList, valueList);
