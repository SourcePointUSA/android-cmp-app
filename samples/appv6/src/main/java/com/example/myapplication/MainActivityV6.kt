...
class MainActivityV6 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        review_consents.setOnClickListener {
            consentLib.loadGDPRPrivacyManager()
        }

        findViewById<View>(R.id.review_consents).setOnClickListener { consentLib.loadGDPRPrivacyManager() }

        review_consents.setOnLongClickListener {
            consentLib.dispose()
            onBackPressed()
            true
        }
