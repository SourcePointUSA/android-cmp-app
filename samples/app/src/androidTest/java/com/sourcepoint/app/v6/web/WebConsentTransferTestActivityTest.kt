...
class WebConsentTransferTestActivityTest {
    ...
    fun user_consents_gdpr_as_accept_all_and_ccpa_as_accept_all(): Unit = runBlocking {
        ...
        onWebView()
            ...
            .check(webMatches(getText(), containsString(CONSENT_TRANSFER_TEST_HEADER)))
        ...
        onWebView()
            .withElement(findElement(Locator.ID, "postMessage"))
            .check(webMatches(getText(), containsString(EVENT_SP_LOAD_CONSENT)))
        onWebView()
            .withElement(findElement(Locator.ID, "postMessage"))
            .check(webMatches(getText(), containsString(EVENT_SP_ON_CONSENT_READY)))
    }
